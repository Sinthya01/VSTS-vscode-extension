...
export class Strings {
    ...
    static NoGitRepoInformation: string = "No Team Services Git repository configuration was found.  Ensure you've opened a folder that contains a Team Services Git repository.";
